 ...
 * 
 * @author kejun.song
 * @version $Id: DebugRequestAndResponseFilter.java, v 0.1 2014年11月19日 上午11:28:30 kejun.song Exp $
 */
public final class DebugRequestAndResponseFilter extends BaseFilter {
    ...
    private void debugRequest(HttpServletRequest request) {
        ...
        log.debug("remote ip:{}  sessionId:{}  ", IpUtils.getIpAddr(request),
    ...
    private void debugResponse(HttpServletResponse response) {
        ...
        log.debug("status:{}", response.getStatus(), response.getCharacterEncoding());
        log.debug("contentType:{}, characterEncoding:{}", response.getCharacterEncoding(),
