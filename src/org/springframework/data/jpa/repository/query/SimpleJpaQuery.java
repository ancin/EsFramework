...
final class SimpleJpaQuery extends AbstractJpaQuery {
    ...
    SimpleJpaQuery(JpaQueryMethod method, EntityManager em, String queryString) {
        ...
        this.countQuery = new StringQuery(
            method.getCountQuery() == null ? QueryUtils.createCountQueryFor(queryString)
    ...
    public Query doCreateQuery(Object[] values) {
        ...
        String sortedQueryString = QueryUtils.applySorting(query.getQuery(), accessor.getSort(),
            query.getAlias());
        ...
        if (method.isNativeQuery()) {
            query = method.isQueryForEntity() ? em.createNativeQuery(sortedQueryString,
                method.getReturnedObjectType()) : em.createNativeQuery(sortedQueryString);
        } else {
    ...
    protected TypedQuery<Long> doCreateCountQuery(Object[] values) {
        return createBinder(values).bind(
            getEntityManager().createQuery(countQuery.getQuery(), Long.class));
    }
