...
<es:contentHeader title="用户登录 ES" index="true" />
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<a class="brand" href="#">&nbsp;&nbsp;</a>
		<ul class="nav">
			<li class="active"><a href="#">登录</a></li>
			<li><a href="http://localhost:8080/EsFramework" target="_blank">我的博客</a></li>
			<li><a href="http://localhost:8080/EsFramework" target="_blank">github</a></li>
		</ul>
		<a class="brand" style="float: right" href="mailto:ancingg@gmail.com"
...
<footer class="footer">
		<p>Licensed <a href="http://www.apache.org/licenses/LICENSE-2.0" 
		target="_blank">Apache License v2.0</a></p>
</footer>
