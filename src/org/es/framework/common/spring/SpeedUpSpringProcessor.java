package org.es.framework.common.spring;
 ...
 * 
 * @author kejun.song
 * @version $Id: SpeedUpSpringProcessor.java, v 0.1 2014年11月19日 上午11:10:00 kejun.song Exp $
 */
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if (className
            .equals("com.sishuok.es.common.repository.support.SimpleBaseRepositoryFactoryBean")
            || className
