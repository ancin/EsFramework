package org.es.framework.common.spring.utils;
 ...
 * 
 * @author kejun.song
 * @version $Id: AopProxyUtils.java, v 0.1 2014年11月19日 上午11:10:42 kejun.song Exp $
 */
public class AopProxyUtils {
    ...
    public static boolean isMultipleProxy(Object proxy) {
        try {
            ...
            TargetSource targetSource = (TargetSource) ReflectionUtils.getField(
                ProxyFactory_targetSource_FIELD, proxyFactory);
    ...
    private static ProxyFactory findJdkDynamicProxyFactory(final Object proxy) {
        ...
        return (ProxyFactory) ReflectionUtils.getField(JdkDynamicAopProxy_advised_FIELD,
            jdkDynamicAopProxy);
    }
    ...
    private static ProxyFactory findCglibProxyFactory(final Object proxy) {
        ...
        return (ProxyFactory) ReflectionUtils.getField(
            CglibAopProxy$DynamicAdvisedInterceptor_advised_FIELD, CGLIB$CALLBACK_0);
    ...
    static {
        ...
        try {
            ...
            JdkDynamicAopProxy_advised_FIELD = ReflectionUtils.findField(JdkDynamicAopProxy_CLASS,
                "advised");
        ...
        ProxyFactory_targetSource_FIELD = ReflectionUtils.findField(ProxyFactory_CLASS,
            "targetSource");
