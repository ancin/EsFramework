package org.es.framework.common.web.controller.permission;
...
public class PermissionList implements Serializable {
     ...
     * value : 资源
     */
    private final Map<String, String> resourcePermissions = Maps.newHashMap();
    ...
    public static PermissionList newPermissionList(String resourceIdentity) {
        ...
        permissionList.resourcePermissions.put(CREATE_PERMISSION, resourceIdentity + ":"
                                                                  + CREATE_PERMISSION);
        permissionList.resourcePermissions.put(UPDATE_PERMISSION, resourceIdentity + ":"
                                                                  + UPDATE_PERMISSION);
        permissionList.resourcePermissions.put(DELETE_PERMISSION, resourceIdentity + ":"
                                                                  + DELETE_PERMISSION);
        permissionList.resourcePermissions.put(VIEW_PERMISSION, resourceIdentity + ":"
                                                                + VIEW_PERMISSION);
    ...
    public void assertHasEditPermission() {
        assertHasAnyPermission(new String[] { CREATE_PERMISSION, UPDATE_PERMISSION,
                DELETE_PERMISSION });
    }
