...
import static com.sishuok.es.maintain.editor.web.controller.utils.OnlineEditorUtils.extractFileInfoMap;
import static com.sishuok.es.maintain.editor.web.controller.utils.OnlineEditorUtils.hasParent;
import static com.sishuok.es.maintain.editor.web.controller.utils.OnlineEditorUtils.sort;
...
public class OnlineEditorController extends BaseController {
    ...
    private final String[] ALLOWED_EXTENSION      = new String[] { "bmp", "gif", "jpeg", "jpg",
            "png", "pdf", "docx", "doc", "xlsx", "xls", "pptx", "ppt", "zip", "rar", "jsp", "jspx",
            "tag", "tld", "xml", "java", "html", "css", "js" };
    ...
    @ResponseBody
    public Object ajaxLoad(@RequestParam("id") long parentId,
        ...
        for (File subFile : parentPathDirectory.listFiles()) {
            ...
            String path = URLEncoder.encode(subFile.getAbsolutePath().replace(rootPath, ""),
                Constants.ENCODING);
    ...
    public String showSelectForm(@RequestParam("paths") String[] excludePaths, Model model)
                                                                                           throws UnsupportedEncodingException {
    ...
    public String showEditForm(@RequestParam(value = "path", required = false, defaultValue = "") String path,
    ...
    public String edit(@RequestParam(value = "path") String path,
    ...
    public String rename(@RequestParam(value = "path") String path,
    ...
    public String delete(@RequestParam(value = "paths") String[] paths,
                         RedirectAttributes redirectAttributes) throws IOException {
    ...
    public String createDirectory(@RequestParam(value = "parentPath") String parentPath,
        ...
        if (isValidFileName(name)) {
            ...
            if (result == false) {
                redirectAttributes
                    .addFlashAttribute(Constants.ERROR, "名称为[" + name + "]的文件/目录已经存在");
            } else {
                redirectAttributes.addFlashAttribute(Constants.MESSAGE, "创建成功！");
            }
        } else {
            redirectAttributes
                .addFlashAttribute(Constants.ERROR, "名称为[" + name + "]不是合法的文件名，请重新命名");
        }
    ...
    public String createFile(@RequestParam(value = "parentPath") String parentPath,
                             @RequestParam(value = "name") String name,
                             RedirectAttributes redirectAttributes) throws IOException {
    ...
    @ResponseBody
    public AjaxUploadResponse upload(HttpServletRequest request,
            ...
            try {
                ...
                if (current.exists() && "ignore".equals(conflict)) {
                    ajaxUploadResponse.add(filename, size,
                        MessageUtils.message("upload.conflict.error"));
                    continue;
                }
                String url = FileUploadUtils.upload(request, parentPath, file, ALLOWED_EXTENSION,
                    MAX_SIZE, false);
                String deleteURL = viewName("/delete") + "?paths="
    ...
    public String compress(@RequestParam(value = "parentPath") String parentPath,
        ...
        String compressPath = parentPath + File.separator + "[系统压缩]"
                              + DateFormatUtils.format(now, pattern) + "-" + System.nanoTime()
                              + ".zip";
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute(
                Constants.MESSAGE,
                String.format(msg, sc.getContextPath(), viewName("download"),
    ...
    public String uncompress(@RequestParam(value = "descPath") String descPath,
                             @RequestParam(value = "paths") String[] paths,
