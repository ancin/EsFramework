...
public class OnlineEditorUtils {
    ...
    public static Map<Object, Object> extractFileInfoMap(File currentFile, String rootPath)
        ...
        info.put("name", name);
        info.put("path", URLEncoder.encode(currentFile.getAbsolutePath().replace(rootPath, ""),
            Constants.ENCODING));
    ...
    private static final String[] CAN_EDIT_EXTENSION = new String[] { "js", "css", "html", "htm",
            "jsp", "jspx", "tld", "tag", "xml", "properties", "txt" };
            ...
            public int compare(Map<Object, Object> o1, Map<Object, Object> o2) {
                ...
                if (nameOrder != null) {
                    ...
                    if (n1IsDirecoty.equals(Boolean.TRUE) && n2IsDirecoty.equals(Boolean.FALSE)) {
                        return -1;
                    } else if (n1IsDirecoty.equals(Boolean.FALSE)
                               && n2IsDirecoty.equals(Boolean.TRUE)) {
                        return 1;
                    }
