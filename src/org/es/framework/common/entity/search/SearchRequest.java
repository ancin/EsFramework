...
import org.es.framework.common.entity.search.utils.SearchableConvertUtils;
 ...
 * 
 * @author kejun.song
 * @version $Id: SearchRequest.java, v 0.1 2014年11月19日 上午10:19:31 kejun.song Exp $
 */
public final class SearchRequest extends Searchable {
    ...
    public Searchable addSearchFilter(final String searchProperty, final SearchOperator operator,
                                      final Object value) {
        SearchFilter searchFilter = SearchFilterHelper
            .newCondition(searchProperty, operator, value);
    ...
    public String toString() {
        return "SearchRequest{" + "searchFilterMap=" + searchFilterMap + ", page=" + page
               + ", sort=" + sort + '}';
    }
}
