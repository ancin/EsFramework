package org.es.framework.common.utils.html;

import org.apache.commons.lang3.StringUtils;
import org.es.framework.common.utils.html.jsoup.SishuokCleaner;
import org.es.framework.common.utils.html.jsoup.SishuokWhitelist;
...
public class HtmlUtils {
    ...
    public static String removeUnSafeTag(String html) {
        ...
        whitelist.addTags("a", "b", "blockquote", "br", "caption", "cite", "code", "col",
            "colgroup");
        whitelist.addTags("dd", "dl", "dt", "em", "hr", "h1", "h2", "h3", "h4", "h5", "h6", "i",
            "img");
        whitelist.addTags("li", "ol", "p", "pre", "q", "small", "strike", "strong", "sub", "sup",
            "table");
